...
export default function TrainingPanel({
  ...
  if (!activeModule) {
    return (
      <div className="flex h-full flex-col bg-card animate-in fade-in slide-in-from-left-2 duration-200">
        {/* Tab bar */}
  ...
  return (
    <div className="flex h-full flex-col bg-card animate-in fade-in slide-in-from-right-2 duration-200">
      {/* Tab bar */}
      <div className="flex items-center border-b border-border shrink-0">
        <div className="flex flex-1">
          {tabs.map(({ id, icon: Icon, label }) => {
